...
// Makina acip kapatildiginda bilgileri hafýzada tutmak icin kullanýlan EEPROM'a kayýt yapabilmek icin kullanýlan Kutuphane
#include <EEPROM.h>
// Zaman hesaplarý ve Saat makina kapalý olsada calismasi ve zamani tutmasi icin gerekli kutuphane
#include  <virtuabotixRTC.h>
// I2C ile calisan Saat (RTC) ve LCD ile haberlesmek icin gereken kutuphane
#include <Wire.h>
// Sýcaklik sensoru DHT11 veya DHT22 yi kullanabilmek icin gereken kutuphane
#include "DHT.h" // sýcaklýk kütüphanesi
#define nem A1
#define isi A2
...
//Sicaklýk Tanýmlamasý Yapýyoruz
...
pinMode(isi, OUTPUT);
  ...
  lev0=EEPROM.read(16);
  myservo.attach(3);
  dht.begin();                       // Isý Sensorunu Baslatiyoruz
myservo.write(90);
...
lev1=0;
  ...
  // I2C iletiþimi icin Wire protokolunu baslatiyoruz
  Wire.begin();                     
